...
def preprocess_yellow_pages_an_yelp(yelp_raw_csv_file, yellow_pages_csv_file):
    ...
    logger.info("The Yelp data CSV file is deduplicated, and cleaned.")
    df_ready_for_enrichment.to_csv('enriched_restaurants_data.csv', index=False)
    logger.info("The enriched restaurants data is deduplicated, cleaned and is a CSV.")
